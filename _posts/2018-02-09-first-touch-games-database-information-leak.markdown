...
Hi everyone in this post I'll show you how I found out **[First Touch Games](http://www.firsttouchgames.com) database information**. It is actually happens because of a common mistake. Let's see.

**FTS** is a **popular football game** which is available on Android and iOS platforms. I don't know why but they are still using very old version of **Wordpress** regularly. I used **WpScan** tool in **kali linux**. Actually this vulnerability was revealed too easily to me. But I want to let you know.
