...
I found a way to **bypass two factor authentication** on login.gov which contains critical information in it. This vulnerability occurs because of the misconfigurated token.
...
All you need to insert your confirmation token you get from your email. It says "This link will expire in 24 hours." but it is not and it can be used multiple times. :)
...
Because of the structure of this site, when you use vulnerable link, you'll be directly in your account. Because server thinks that you didn't add phone information and set password. So how could it ask for a password or 2FA?
...
- Nov 3rd 2017 - Waiting for disclose.
